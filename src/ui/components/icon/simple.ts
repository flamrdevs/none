...
const SimpleIcons = {
  ...
  bootstrap: createSimpleIcon(si.siBootstrap.path),
  ...
  jquery: createSimpleIcon(si.siJquery.path),
  ...
  mantine: createSimpleIcon(si.siMantine.path),
  ...
  'socket.io': createSimpleIcon(si.siSocketdotio.path),
  ...
  swc: createSimpleIcon(si.siSwc.path),
  swr: createSimpleIcon(si.siSwr.path),
  ...
  umami: createSimpleIcon(si.siUmami.path),
